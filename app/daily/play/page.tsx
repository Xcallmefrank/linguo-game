            ...
            <div className="relative space-y-6">
              <div className="text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-400">
                  {invitedBy
                    ? locale === "en"
                      ? `${invitedBy} sent you here. Try not to embarrass the species.`
                      : `${invitedBy} ti ha mandato qui. Prova a non deludere la specie.`
                    : locale === "en"
                      ? "One question. No obvious hints. Finally."
                      : "Una domanda. Nessun indizio regalato. Finalmente."}
                </p>
              </div>
