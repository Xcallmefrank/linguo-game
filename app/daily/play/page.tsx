                        ...
                        <Card className="relative overflow-hidden rounded-[36px] border border-white/10 bg-black/40 p-7 shadow-[0_20px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
                            ...
                            <div className="relative space-y-6 text-center">
                                ...
                                <div className="rounded-2xl border border-white/10 bg-zinc-950/70 p-4 text-left">
                                    ...
                                    <p
                                        className={`mt-3 text-sm font-medium ${attempt.score > 0 ? "text-green-400" : "text-red-400"
                                            }`}
                                    >
                                        {attempt.score > 0
                                            ? locale === "en"
                                    ...
                                    {question.options.map((option) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                disabled={answered}
                                                className={`rounded-2xl border px-4 py-4 text-left text-sm font-medium transition-all ${selected && correct
